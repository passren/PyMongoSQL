...
class PartiQLParserVisitor(ParseTreeVisitor):
    ...
    def visitInsertCommandReturning(
    ...
    def visitInsertStatementLegacy(
    ...
    def visitFromClauseSimpleExplicit(
    ...
    def visitFromClauseSimpleImplicit(
    ...
    def visitSetQuantifierStrategy(
    ...
    def visitExcludeExprCollectionAttr(
    ...
    def visitExcludeExprCollectionIndex(
    ...
    def visitExcludeExprCollectionWildcard(
    ...
    def visitExcludeExprTupleWildcard(
    ...
    def visitEdgeSpecUndirectedBidirectional(
