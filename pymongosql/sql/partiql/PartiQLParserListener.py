...
class PartiQLParserListener(ParseTreeListener):
    ...
    def enterInsertCommandReturning(
        self, ctx: PartiQLParser.InsertCommandReturningContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#insertCommandReturning.
    def exitInsertCommandReturning(
        self, ctx: PartiQLParser.InsertCommandReturningContext
    ):
        pass
    ...
    def enterInsertStatementLegacy(
        self, ctx: PartiQLParser.InsertStatementLegacyContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#insertStatementLegacy.
    def exitInsertStatementLegacy(
        self, ctx: PartiQLParser.InsertStatementLegacyContext
    ):
        pass
    ...
    def enterFromClauseSimpleExplicit(
        self, ctx: PartiQLParser.FromClauseSimpleExplicitContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#FromClauseSimpleExplicit.
    def exitFromClauseSimpleExplicit(
        self, ctx: PartiQLParser.FromClauseSimpleExplicitContext
    ):
        pass

    # Enter a parse tree produced by PartiQLParser#FromClauseSimpleImplicit.
    def enterFromClauseSimpleImplicit(
        self, ctx: PartiQLParser.FromClauseSimpleImplicitContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#FromClauseSimpleImplicit.
    def exitFromClauseSimpleImplicit(
        self, ctx: PartiQLParser.FromClauseSimpleImplicitContext
    ):
        pass
    ...
    def enterSetQuantifierStrategy(
        self, ctx: PartiQLParser.SetQuantifierStrategyContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#setQuantifierStrategy.
    def exitSetQuantifierStrategy(
        self, ctx: PartiQLParser.SetQuantifierStrategyContext
    ):
        pass
    ...
    def enterExcludeExprCollectionAttr(
        self, ctx: PartiQLParser.ExcludeExprCollectionAttrContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#ExcludeExprCollectionAttr.
    def exitExcludeExprCollectionAttr(
        self, ctx: PartiQLParser.ExcludeExprCollectionAttrContext
    ):
        pass

    # Enter a parse tree produced by PartiQLParser#ExcludeExprCollectionIndex.
    def enterExcludeExprCollectionIndex(
        self, ctx: PartiQLParser.ExcludeExprCollectionIndexContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#ExcludeExprCollectionIndex.
    def exitExcludeExprCollectionIndex(
        self, ctx: PartiQLParser.ExcludeExprCollectionIndexContext
    ):
        pass

    # Enter a parse tree produced by PartiQLParser#ExcludeExprCollectionWildcard.
    def enterExcludeExprCollectionWildcard(
        self, ctx: PartiQLParser.ExcludeExprCollectionWildcardContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#ExcludeExprCollectionWildcard.
    def exitExcludeExprCollectionWildcard(
        self, ctx: PartiQLParser.ExcludeExprCollectionWildcardContext
    ):
        pass

    # Enter a parse tree produced by PartiQLParser#ExcludeExprTupleWildcard.
    def enterExcludeExprTupleWildcard(
        self, ctx: PartiQLParser.ExcludeExprTupleWildcardContext
    ):
        pass

    # Exit a parse tree produced by PartiQLParser#ExcludeExprTupleWildcard.
    def exitExcludeExprTupleWildcard(
        self, ctx: PartiQLParser.ExcludeExprTupleWildcardContext
    ):
        pass
